...
- ~~**Sorceress.games asset bake-off (Phase 2)**~~ **DONE 2026-07-25** — scored [[decisions/2026-07-25-briar-pose-bakeoff]]: Arm A (Imagine) wins pose stand-ins and is wired interim; PixelLab style-lock but pose-fail; Sorceress not run (human recipe in bakeoff folder). **Do not add Sorceress to stack yet.** WizardGenie still rejected.
