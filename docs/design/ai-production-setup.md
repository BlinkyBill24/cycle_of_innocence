...
- **⚠ LimboAI is a GDExtension** (v1.6.0, gdextension-4.4): GDExtension Web export has historically been fragile — **verify LimboAI exports cleanly to Web early**, don't assume it just works. (Open risk — see [[ideas]].)
