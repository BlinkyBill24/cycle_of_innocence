...
======================================================================
SOURCE: docs/decisions/2026-06-13-inventory-system.md
======================================================================
...
- **Definitions are data-driven `ItemDef` .tres** (`scripts/items/item_def.gd`), loaded once and cached by an `ItemRegistry` autoload. New item = drop a `.tres`. Effects dispatch on a small `use_kind` enum (v1: `NONE`, `FEED_COMPANION`; `HEAL`/`REDUCE_DREAD` reserved).
